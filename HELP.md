...
* The original package name 'com.example.ai-interview-agent' is invalid and this project uses 'com.example.ai_interview_agent' instead.
...
* [WebSocket](https://docs.spring.io/spring-boot/3.5.10-SNAPSHOT/reference/messaging/websockets.html)
